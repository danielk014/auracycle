...
import { getCycleLogs } from "@/lib/db";
...
export default function Insights() {
  ...
  // Mood frequency
  const moodFreq = {};
  logs.forEach((l) => l.moods?.forEach((m) => {
  ...
  return (
    <div className="pb-28 px-4 pt-10 max-w-lg mx-auto">
      ...
      {symptomData.length > 0 && (
        ...
        >
          <h3 className="text-sm font-bold text-slate-700 mb-4">Top Symptoms</h3>
      ...
      {moodData.length > 0 && (
        ...
        >
          ...
          <div className="flex items-center justify-center">
            <ResponsiveContainer width="100%" height={200}>
              <PieChart>
                <Pie data={moodData} cx="50%" cy="50%" innerRadius={50} outerRadius={80} paddingAngle={3} dataKey="value">
